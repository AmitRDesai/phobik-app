...
// Old hi-res (4096²) tapping figure restored from git history — the version
// before commit 6147649 downscaled the shared asset to 119 KB. The tapping-
// point dot coordinates in `tappingPoints.ts` are calibrated to this image,
// so the POC ships its own copy to keep the highlights aligned.
import MEDITATION_IMAGE from '../assets/tapping-figure-hires.png';
