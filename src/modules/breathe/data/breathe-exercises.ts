...
export const BREATHE_EXERCISES: BreatheExercise[] = [
  {
    ...
    introRoute: '/breathe/box-breathing-intro',
    image: boxImg,
  },
  {
    id: 'breathing-478',
    ...
    introRoute: '/breathe/478-breathing-intro',
    image: box478Img,
  },
  {
    id: 'star-breathing',
    ...
    levels: ['Mild', 'Calm'],
    introRoute: '/breathe/star-breathing-intro',
    image: starImg,
  },
  {
    id: 'lazy-8',
    ...
    levels: ['Mild', 'Calm'],
    introRoute: '/breathe/lazy-8-breathing-intro',
    image: lazy8Img,
  },
  {
    id: 'double-inhale',
    ...
    introRoute: '/breathe/double-inhale-intro',
  ...
  },
  {
    ...
    introRoute: '/breathe/grounding-intro',
    image: groundingImg,
  },
];
